if ((window.location.href.indexOf('/_layouts') < 0 || (window.location.href.indexOf('/_layouts') >= 0 && window.location.href.indexOf('start.aspx#') >= 0)) && window.location.href.indexOf('/_catalogs') < 0 && window.location.href.indexOf('admin=1') < 0 && window.location.href.indexOf('AllItems.aspx') < 0 && window.location.href.indexOf('DispForm.aspx') < 0 && window.location.href.indexOf('EditForm.aspx') < 0 && window.location.href.indexOf('AllPages.aspx') < 0) {
    ...
    document.write('<link id="gc_responsive_ui_css" rel="stylesheet" href="' + c + '/Style%20Library/SP.Responsive.UI/GC_responsive_ui.css?rev=8" /> <link rel="stylesheet" href="' + c + '/Style%20Library/SP.Responsive.UI/EmergencyBroadcast.css?rev=8" /> <link rel="stylesheet" href="' + c + '/Style%20Library/SP.Responsive.UI/georgianicon.css?rev=8" /> <link rel="stylesheet" href="https://static2.sharepointonline.com/files/fabric/office-ui-fabric-js/1.3.0/css/fabric.min.css" /> ');
    ...
    newScript.src = c + '/Style%20Library/SP.Responsive.UI/GC-Responsive-UI.js?rev=3';
    newScript.id = 'PnPResponsiveUI';
    headID.appendChild(newScript);
    var newScript1 = document.createElement('script');
    newScript1.type = 'text/javascript';
    newScript1.src = c + '/Style%20Library/SP.Responsive.UI/georgianfeedback.js?rev=bf19e4f64b204e1ebc2f762e33afcc97';
    newScript1.id = 'FeedbackScript';
    headID.appendChild(newScript1);
    var newScript2 = document.createElement('script');
    newScript2.type = 'text/javascript';
    newScript2.src = c + '/Style%20Library/SP.Responsive.UI/checkeditmode.js?rev=bf19e4f64b204e1ebc2f762e33afcc97';
    newScript2.id = 'checkeditmode';
    headID.appendChild(newScript2);
    var newScript3 = document.createElement('script');
    newScript3.type = 'text/javascript';
    newScript3.src = c + '/Style%20Library/SP.Responsive.UI/georgianuserprofileproperties.js?rev=bf19e4f64b204e1ebc2f762e33afcc97';
    ...
    newScript4.src = c + '/Style%20Library/SP.Responsive.UI/EmergencyBroadcast.js?rev=bf19e4f64b204e1ebc2f762e33afcc97';
